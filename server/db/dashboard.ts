...
export async function getMembersSubscriptionById(
  ...
  return db.raw(
    ...
    LEFT JOIN member_subscriptions
      ON member_subscriptions.member_id = member_profiles.stripe_id
    LEFT JOIN subscriptions
      ON member_subscriptions.subscriptions_id = subscriptions.id
    WHERE member_profiles.auth0_id = $1 OR member_profiles.stripe_id = $1
    LIMIT 1`,
    [id]
  )
}
